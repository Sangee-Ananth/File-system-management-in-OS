    ...
    private void initialize() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                SSTF sf=new SSTF();
                try {
                    SSTF.setSize(Integer.parseInt(textField_2.getText()));
                    SSTF.setDisk_size(Integer.parseInt(textField.getText()));
                    head=Integer.parseInt(textField_1.getText());
                    input=textField_3.getText();
                    String[] arr= input.split(",");
                    SSTF.SSTF(arr, head);
                    textField_4.setText(Integer.toString(sf.getSeek_count()));
                    textField_5.setText(SSTF.getSequnce());
        ...
        JLabel lblNewLabel_4 = new JLabel("SSTF");
